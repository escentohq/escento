...
function InstagramIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <rect x="2.75" y="2.75" width="18.5" height="18.5" rx="4" ry="4" fill="none" stroke="currentColor" strokeWidth="1.5" />
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:gap-12">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm font-medium text-[#475569]">
            ...
            {/* Legal nav */}
            <Link href="/privacy" className="text-xs text-[#94A3B8] transition-colors hover:text-[#0055FF]">
              Privacy
            </Link>
            <Link href="/terms" className="text-xs text-[#94A3B8] transition-colors hover:text-[#0055FF]">
              Terms
            </Link>
            <Link href="/compliance" className="text-xs text-[#94A3B8] transition-colors hover:text-[#0055FF]">
              Compliance
            </Link>
          </div>
