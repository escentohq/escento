...
type Props = { href: string; children: React.ReactNode; icon?: LucideIcon; className?: string; prefetch?: boolean };

export function SecondaryCta({ href, children, icon: Icon, className = "", prefetch }: Props) {
  return (
    <Link
      href={href}
      prefetch={prefetch}
