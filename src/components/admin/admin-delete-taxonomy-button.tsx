  ...
  return (
    <div className="space-y-1">
      <button
        ...
        onClick={submit}
        disabled={isPending}
        className="inline-flex min-h-9 items-center border border-coral px-3 text-control text-coral transition-colors hover:bg-coral hover:text-white disabled:opacity-50"
      >
