  ...
  return (
    <>
      <button
        ...
        className={`inline-flex min-h-9 items-center  border px-3 text-xs font-bold transition-colors focus-visible:outline-2 focus-visible:outline-[#0055FF] focus-visible:outline-offset-2 ${
          tone === "danger"
          ...
          <div role="dialog" aria-modal="true" className="relative w-full max-w-lg  border border-[#F1F5F9] bg-white p-6 shadow-2xl">
            ...
            <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                onClick={submit}
                disabled={isPending}
                className="inline-flex min-h-11 items-center justify-center  bg-[#0F172A] px-5 text-sm font-bold text-white transition-colors hover:bg-[#0055FF] disabled:opacity-50"
              >
