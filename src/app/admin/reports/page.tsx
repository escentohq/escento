  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="min-h-10 min-w-0 flex-1  border border-[#E2E8F0] bg-white px-3 text-xs font-medium text-[#0F172A] shadow-sm focus:border-[#0055FF] focus:outline-none focus:ring-2 focus:ring-[#0055FF]/20"
      />
      <button
        type="submit"
        className="inline-flex min-h-10 shrink-0 items-center  border border-[#E2E8F0] px-3 text-xs font-black text-[#0F172A] transition-colors hover:border-[#0055FF] hover:text-[#0055FF] focus-visible:outline-2 focus-visible:outline-[#0055FF] focus-visible:outline-offset-2"
      >
        {label}
      </button>
    </form>
...
export default async function AdminReportsPage() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6  border border-[#F1F5F9] bg-white p-5 shadow-sm">
          ...
          {reports.map((report) => (
            ...
            >
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div className=" bg-[#F8FAFC] p-4 text-sm">
              ...
              <div className="mt-5 grid gap-4 lg:grid-cols-2">
                <div className=" border border-[#F1F5F9] p-4">
              ...
              {report.adminNotes ? (
                <div className="mt-4  bg-[#0055FF]/5 p-4">
